...
# from eversec.settings import Log_file_path, DATABASE, APK_DOEN
import requests
...
Log_file_path = r'E:\gitlab\crawler-web\eversec\eversec\log\scrapy_2022_3_22.log'
print('Log_file_path', Log_file_path)
logger = logging.getLogger('tiankong')
